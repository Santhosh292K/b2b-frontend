                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="font-semibold text-slate-800 text-base group-hover:text-violet-600 transition-colors">
                                            ...
                                            {appointment.message && (
                                                <div className="mt-3 ml-16">
                                                    <p className="text-sm text-slate-600 bg-slate-50 rounded-lg px-4 py-2.5 border border-slate-100">
                                                        {appointment.message}
                                                    </p>
                                                </div>
                                            )}
